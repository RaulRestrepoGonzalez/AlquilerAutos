...
namespace BLL
{
    public class PersonaService
    {
        ...
        public string Eliminar(int Id)
        {
            try
            {
                if (personaRepository.Buscar(Id) != null)
                {
                    ...
                    return $"se elimino la persona numero: {Id} correctamente";
                }
                return $"El numero de persona no esta registrado en el sistema";
            }
            catch (Exception e)
            {
        ...
        public string Modificar(int Id, List<Persona> personas)
        {
            try
            {
                if (personaRepository.Buscar(Id) != null)
                {
                    personaRepository.Modificar(Id, personas);
                    return $"la persona numero: {Id} ha sido modificada con exito!";

                }
                return $"El numero de persona: {Id} no se encuentra registrada por favor verifique los datos";
